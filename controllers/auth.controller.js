...
exports.signupProcess = (req, res, next) => {
  ...
  if (!firstName) {
    return res
      .status(400)
      .json({
        errorMessage: "You have to put a fist name"
      });
  }
  if (!lastName) {
    return res
      .status(400)
      .json({
        errorMessage: "You have to put a last name"
      });
  }
  if (!email) {
    return res
      .status(400)
      .json({
        errorMessage: "You have to fill an email"
      });
  }
  ...
  try {
    ...
    if (!user) {
      return res
        .status(400)
        .json({
          errorMessage: "Oye tus credenciales son erroneas "
        })
    }
